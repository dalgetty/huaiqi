...
Most of the multi-grasp commercial hands provide rotating thumbs because thumb movements were reported to contribute, arguably, to \SI{40}{\%} of all hand movements \cite{michael2004atlas}.  The weights of commercial prostheses range from \SI{350}{g} to \SI{615}{g} \cite{belter2013mechanical}, which is comparable to the weight of a natural hand. %, which weighs around \SI{400}{g}.
...
A qualitative comparison of the above mentioned actuators is shown in Table \ref{tab:vibrotactile_actuator_comparison}. 
\begin{table}[htp!]
\center
